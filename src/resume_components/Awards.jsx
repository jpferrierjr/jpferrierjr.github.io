...
export default function AwardsPage()
{
    const MilitaryAwardsList = military_awards.map( ma => 
            <div key={ma.id} className="Job text-sm md:text-base italic text-slate-700 font-bold">
    ...
    const AwardsList = awards.map( aw => {
        return(
            <div key={aw.id} className="py-4 container mx-auto ">
                <div className="grid grid-rows-1 md:grid-cols-[120px_1fr]">
                    <div className="hidden md:flex row-span-2 p-4 justify-center items-center">
                        <div><img src={aw.image} className="justify-center items-center w-16" alt="Award" /> </div>
                    </div>
                    <div className="Award font-bold text-slate-700 text-base md:text-lg">
                        <a href={aw.link} target="_blank" rel="noopener noreferrer">{aw.title}</a>
                    </div>
                    <div className="AwardDesc text-sm md:text-base text-slate-800">
                        {aw.description}
                    </div>
                </div>
            </div>
    ...
    return(
        <>
            <div className="text-2xl md:text-3xl">Awards & Honors</div>
            <div className="text-pretty">
                <div className="text-xl md:text-2xl pb-2">
                ...
                <div className="py-4 container mx-auto ">
                    <div className="grid lg:grid-cols-[250px_1fr_1fr]">
                        <div className="hidden lg:flex p-4 px-6 justify-center items-center" style={{gridRow: "1 / 14"}}>
